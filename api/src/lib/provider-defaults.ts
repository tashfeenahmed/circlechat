...
//
// The Hermes config template ships with `model.default: claude-sonnet-4-5`,
// which is Anthropic's NATIVE id. Every other provider spells models
// differently — OpenRouter wants `vendor/model` (`anthropic/claude-sonnet-4.5`)
